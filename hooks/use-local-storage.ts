 ...
 * @return Returns three values: the current value stored in local storage, a function to set/update value in the local storage, and a boolean indicating if the local storage is loading.
 */
